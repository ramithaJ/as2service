...
public class AuthorServicesConstants {
    ...
    /** The Constant INVITE_RESET_PASSWORD_STATUS_TYPE_VERIFIED. */
    public static final String INVITE_RESET_PASSWORD_STATUS_TYPE_VERIFIED = "VERIFIED";

    /** The Constant VERIFY_ACCOUNT_ACTIVE. */
    public static final String VERIFY_ACCOUNT_ACTIVE = "Active";
    ...
    public static enum OO_ORDER_STATUS {
        ...
        /** The submit order. */
        SUBMIT_ORDER,
        /** The online open req rcvd. */
        ONLINE_OPEN_REQ_RCVD,
        /** The new order created. */
        NEW_ORDER_CREATED,
        /** The order updated. */
        ORDER_UPDATED,
        /** The order funding approved. */
        ORDER_FUNDING_APPROVED,
        /** The order funding denied. */
        ORDER_FUNDING_DENIED,
        /** The customer account on hold. */
        CUSTOMER_ACCOUNT_ON_HOLD,
        /** The new invoice generated. */
        NEW_INVOICE_GENERATED,
        /** The payment confirmed. */
        PAYMENT_CONFIRMED,
        /** The content not received. */
        CONTENT_NOT_RECEIVED,
        /** The retry identifier updated. */
        RETRY_IDENTIFIER_UPDATED,
        /** The retry dss unavailable. */
        RETRY_DSS_UNAVAILABLE,
        /** The retry dss not found. */
        RETRY_DSS_NOT_FOUND,
        /** The request to wcr dss failed. */
        REQUEST_TO_WCR_DSS_FAILED,
        /** The article online open. */
        ARTICLE_ONLINE_OPEN,
        /** The open article request send. */
        OPEN_ARTICLE_REQUEST_SEND,
        ...
        /** The cancellation received no matching order found. */
        CANCELLATION_RECEIVED_NO_MATCHING_ORDER_FOUND,
        /** The customer step complete. */
        CUSTOMER_STEP_COMPLETE,
        /** The customer step failed. */
        CUSTOMER_STEP_FAILED,
        /** The order amount calculated. */
        ORDER_AMOUNT_CALCULATED,
        /** The amount calculation failed. */
        AMOUNT_CALCULATION_FAILED,
        /** The pending for funder approval. */
        PENDING_FOR_FUNDER_APPROVAL,
        /** The multiple articles found. */
        MULTIPLE_ARTICLES_FOUND,
        /** The article not found. */
        ARTICLE_NOT_FOUND,
        /** The cannot identify journal. */
        CANNOT_IDENTIFY_JOURNAL,
        /** The duplicate order found. */
        DUPLICATE_ORDER_FOUND,
        /** The issn updated. */
        ISSN_UPDATED,
        /** The article step complete. */
        ARTICLE_STEP_COMPLETE,
        /** The request to create proforma invoice. */
        REQUEST_TO_CREATE_PROFORMA_INVOICE,
        /** The order for payment entered. */
        ORDER_FOR_PAYMENT_ENTERED,
        /** The order creation failed. */
        ORDER_CREATION_FAILED,
        /** The on hold. */
        ON_HOLD,
        /** The automated processing disabled. */
    ...
    /** The Constant AS_ALM_USER_TYPE. */
    public static final String AS_ALM_USER_TYPE = "User";

    /** The Constant CDM_AUTHOR_FLAG. */
    public static final String CDM_AUTHOR_FLAG = "Y";

    /** The Constant CDM_REG_FLAG. */
    public static final String CDM_REG_FLAG = "Y";
