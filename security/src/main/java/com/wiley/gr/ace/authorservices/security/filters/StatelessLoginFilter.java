...
public class StatelessLoginFilter extends
    ...
    protected void successfulAuthentication(final HttpServletRequest request,
        ...
        if (!StringUtils.equalsIgnoreCase(StatelessLoginFilter.ADMIN,
            ...
            if ("Y".equalsIgnoreCase(almUser.getTermsOfUseFlg())
                    && almUser.getStatus().equalsIgnoreCase(
                            AuthorServicesConstants.VERIFY_ACCOUNT_ACTIVE)) {

                userDetails = userLoginService
                        .getUserDetailsFromParticipantService(unp.getUsername());

            } else if ("N".equalsIgnoreCase(almUser.getTermsOfUseFlg())
                    && almUser.getStatus().equalsIgnoreCase(
                            AuthorServicesConstants.VERIFY_ACCOUNT_ACTIVE)) {
            ...
            } else if ("Y".equalsIgnoreCase(almUser.getTermsOfUseFlg())
                    && almUser
                            .getStatus()
                            .equalsIgnoreCase(
