...
public class DashboardServiceImpl implements DashboardService {
	...
	private List<DashboardInfo> checkingDashboardInfo(UserProfile userProfile) throws Exception {
		...
		dashboardInfo = getSecurityDetailsForUser(userProfile.getCustomerDetails().getPrimaryEmailAddr());
