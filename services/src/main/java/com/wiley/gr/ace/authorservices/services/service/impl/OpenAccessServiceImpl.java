...
public class OpenAccessServiceImpl implements OpenAccessService {
    ...
    public OpenAccessPaymentData getOpenAccessDetails(final String articleId,
        ...
        discountDetail.setDiscountAmount(quote.getDiscount()
                .getDiscountAmount());
        discountDetail.setDiscountPercent(quote.getDiscount()
                .getDiscountPercent());
        ...
        taxDetails.setTaxCountryCode(quote.getAddressOnFile()
                .getBillingCountry());
