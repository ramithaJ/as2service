...
public class PasswordUpdate {
    ...
    private PasswordRequest updateUserSecurityAttributes;
     ...
     */
    public final PasswordRequest getUpdateUserSecurityAttributes() {
    ...
    public final void setUpdateUserSecurityAttributes(
            final PasswordRequest updateUserSecurityAttributes) {
